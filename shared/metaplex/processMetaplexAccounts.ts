...
import { METAPLEX_ID } from './common';
import {
  AuctionManagerV2,
  BidRedemptionTicket,
...
export const processMetaplexAccounts: ProcessAccountsFunc = async (
	...
	try {
		...
		// FIXME: FIXED STORE ID
		const STORE_ID = new PublicKey('');
...
const isStoreV1Account = (account: AccountInfo<Buffer>) => account.data[0] === MetaplexKey.StoreV1;
