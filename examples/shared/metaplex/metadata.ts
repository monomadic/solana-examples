...
export declare function createMasterEdition(
...
export declare function mintNewEditionFromMasterEditionViaToken(
	newMint: StringPublicKey,
	tokenMint: StringPublicKey,
	newMintAuthority: StringPublicKey,
...
export declare function updatePrimarySaleHappenedViaToken(
	metadata: StringPublicKey,
	owner: StringPublicKey,
	tokenAccount: StringPublicKey,
	instructions: TransactionInstruction[]
): Promise<void>;
export declare function deprecatedCreateReservationList(
	metadata: StringPublicKey,
	masterEdition: StringPublicKey,
...
export declare function signMetadata(
	metadata: StringPublicKey,
	creator: StringPublicKey,
	instructions: TransactionInstruction[]
): Promise<void>;
export declare function deprecatedMintPrintingTokens(
...
export declare function convertMasterEditionV1ToV2(
	masterEdition: StringPublicKey,
...
export declare function deprecatedGetReservationList(
	masterEdition: StringPublicKey,
	resource: StringPublicKey
): Promise<StringPublicKey>;
export declare function getEditionMarkPda(
	mint: StringPublicKey,
	edition: BN
): Promise<StringPublicKey>;
